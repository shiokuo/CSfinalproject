...
#import main
def word(string,color=(255,69,2),coef=1,size=40):
...
def change_plot (status):
    if status==0:      #breakfaststealer
        ...
        plot_1=my_font.render('You\'re going to enjoy your breakfast,only to find it be stolen!',999,(255,69,2))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
        f=my_font.render('press f to continue',999,(255,69,2))
        screen.blit(f,(x,400))
    ...
    if status==4:      #OXO
        ...
        plot_1=my_font.render('Now, a man who teaches Earth Science blocks your way.',999,(255,69,2))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
    ...
    if status==8:      #tanya
        ...
        plot_1=my_font.render('A chemistry teacher stands in front of you.',999,(255,69,2))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
...
def fight(status):
    ...
    if status==1:
        ...
        f=my_font.render('1:event 2:skill 3:item',999,(255,69,2))
        screen.blit(f,(0,420))
        pygame.display.update()
        return 1
    if status==5:
...
def choice_battle(status):
    if status[0]!=1 and status[1]!=1:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('(q)attack(w)charging',999,(255,215,0))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
    if status[0]==1:
        my_font = pygame.font.SysFont('Comic Sans MS', 35)
        plot_1=my_font.render('(q)attack(w)charge(e)weaken',999,(255,215,0))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
    if status[1]==1:
        ...
        plot_1=my_font.render('(q)attack(w)charge(e)weaken(r)strong charge',999,(255,215,0))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
...
def feed():
    '''fail'''    
    my_font = pygame.font.SysFont('Comic Sans MS', 50)
    plot_1=my_font.render('The thief bites you and runs away.',999,(255,215,0))
    x=((640-plot_1.get_width()))/2
    y=((480-plot_1.get_height()))/2
    screen.blit(background,(0,0))
    screen.blit(plot_1,(x,y))
...
def capture():
    '''fail'''    
    my_font = pygame.font.SysFont('Comic Sans MS', 50)
    plot_1=my_font.render('It ran away. lol',999,(255,215,0))
    x=((640-plot_1.get_width()))/2
    y=((480-plot_1.get_height()))/2
    screen.blit(background,(0,0))
    screen.blit(plot_1,(x,y))
...
def clean(): 
    ...
    my_font = pygame.font.SysFont('Comic Sans MS', 50)
    plot_1=my_font.render('Bro, you are a good student.',999,(255,215,0))
    x=((640-plot_1.get_width()))/2
    y=((480-plot_1.get_height()))/2
    screen.blit(plot_1,(x,y))
    pygame.display.update()
def dance():
    ...
    my_font = pygame.font.SysFont('Comic Sans MS', 50)
    plot_1=my_font.render('Now he is flying into a rage.',999,(255,215,0))
    x=((640-plot_1.get_width()))/2
    y=((480-plot_1.get_height()))/2
    screen.blit(plot_1,(x,y))
    pygame.display.update()
def mind_map():
    '''blood up(use heal) '''    
    my_font = pygame.font.SysFont('Comic Sans MS', 50)
    plot_1=my_font.render('Well done.',999,(255,215,0))
    x=((640-plot_1.get_width()))/2
    y=((480-plot_1.get_height()))/2
    screen.blit(plot_1,(x,y))
    pygame.display.update()
...
def reward(status):
    if status==2:
        ...
        plot_1=my_font.render('choose your reward(z)weaken(x)a new breakfast(c)a sword',999,(255,69,2))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(background,(0,0))
    ...
    if status==6:
        my_font = pygame.font.SysFont('Comic Sans MS', 25)
        plot_1=my_font.render('choose your reward(z)strong charge(x)stone statue(c)shield',999,(255,69,2))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(background,(0,0))
        screen.blit(plot_1,(0,420))
