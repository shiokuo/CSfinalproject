...
#import main
def word(string,color=(127,255,212),coef=1,size=40):
...
def change_plot (status):
    if status==0:      #breakfaststealer
        ...
        plot_1=my_font.render('You\'re going to enjoy your breakfast,only to find it be stolen!',999,(127,255,212))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
        f=my_font.render('press f to continue',999,(127,255,212))
        screen.blit(f,(x,400))
    ...
    if status==4:      #OXO
        ...
        plot_1=my_font.render('Now, a man who teaches Earth Science blocks your way.',999,(127,255,212))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
    ...
    if status==8:      #tanya
        ...
        plot_1=my_font.render('A chemistry teacher stands in front of you.',999,(127,255,212))
        x=((640-plot_1.get_width()))/2
        y=((480-plot_1.get_height()))/2
        screen.blit(background,(0,0))
        screen.blit(plot_1,(x,y))
...
def fight(status):
    ...
    if status==1:
        ...
        f=my_font.render('1:event 2:skill 3:item',999,(127,255,212))
        screen.blit(f,(0,420))
        pygame.display.update()
        return 1
    if status==5:
...
def choice_event(status):
    if status == 1:
        ...
        plot_1=my_font.render('(q)feed more food(w)capture it',999,(127,255,212))
    ...
    if status == 5:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('(q)clean the floor(w)ask him to dance',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
    ...
    if status == 9:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('(q)draw a mind map(w)hide it in the trashcan',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
...
def choice_item(status):
    if status[0]!=2 and status[1]!=2:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('nothing',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
    if status[0]==2:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('breakfast(q)',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
    if status[1]==2:
        my_font = pygame.font.SysFont('Comic Sans MS', 45)
        plot_1=my_font.render('stone statue(w)',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(plot_1,(0,370))
        pygame.display.update()
...
def reward(status):
    if status==2:
        ...
        plot_1=my_font.render('choose your reward(z)weaken(x)a new breakfast(c)a sword',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(background,(0,0))
    ...
    if status==6:
        my_font = pygame.font.SysFont('Comic Sans MS', 25)
        plot_1=my_font.render('choose your reward(z)strong charge(x)stone statue(c)shield',999,(127,255,212))
        #x=2*((640-plot_1.get_width()))/3
        #y=((480-plot_1.get_height()))/3
        screen.blit(background,(0,0))
        screen.blit(plot_1,(0,420))
